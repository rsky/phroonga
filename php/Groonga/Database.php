...
class Database extends Object
{
    ...
    const BUILTIN_TOKENIZER_MECAB   = \GRN_DB_MECAB;
    const BUILTIN_TOKENIZER_DELIMIT = \GRN_DB_DELIMIT;
    const BUILTIN_TOKENIZER_UNIGRAM = \GRN_DB_UNIGRAM;
    const BUILTIN_TOKENIZER_BIGRAM  = \GRN_DB_BIGRAM;
    const BUILTIN_TOKENIZER_TRIGRAM = \GRN_DB_TRIGRAM;
