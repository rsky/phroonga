...
static void prn_register_obj_flags(INIT_FUNC_ARGS);
...
PRN_LOCAL void prn_register_constants(INIT_FUNC_ARGS)
{
	...
	prn_register_obj_flags(INIT_FUNC_ARGS_PASSTHRU);
...
/* }}} */
/* {{{ prn_register_obj_flags() */

static void prn_register_obj_flags(INIT_FUNC_ARGS)
{
	PRN_REGISTER_CONSTANT(GRN_OBJ_TABLE_TYPE_MASK);
	PRN_REGISTER_CONSTANT(GRN_OBJ_TABLE_HASH_KEY);
	PRN_REGISTER_CONSTANT(GRN_OBJ_TABLE_PAT_KEY);
	PRN_REGISTER_CONSTANT(GRN_OBJ_TABLE_DAT_KEY);
	PRN_REGISTER_CONSTANT(GRN_OBJ_TABLE_NO_KEY);

	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_MASK);
	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_UINT);
	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_INT);
	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_FLOAT);
	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_GEO_POINT);

	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_WITH_SIS);
	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_NORMALIZE);

	PRN_REGISTER_CONSTANT(GRN_OBJ_COLUMN_TYPE_MASK);
	PRN_REGISTER_CONSTANT(GRN_OBJ_COLUMN_SCALAR);
	PRN_REGISTER_CONSTANT(GRN_OBJ_COLUMN_VECTOR);
	PRN_REGISTER_CONSTANT(GRN_OBJ_COLUMN_INDEX);

	PRN_REGISTER_CONSTANT(GRN_OBJ_COMPRESS_MASK);
	PRN_REGISTER_CONSTANT(GRN_OBJ_COMPRESS_NONE);
	PRN_REGISTER_CONSTANT(GRN_OBJ_COMPRESS_ZLIB);
	PRN_REGISTER_CONSTANT(GRN_OBJ_COMPRESS_LZO);

	PRN_REGISTER_CONSTANT(GRN_OBJ_WITH_SECTION);
	PRN_REGISTER_CONSTANT(GRN_OBJ_WITH_WEIGHT);
	PRN_REGISTER_CONSTANT(GRN_OBJ_WITH_POSITION);
	PRN_REGISTER_CONSTANT(GRN_OBJ_RING_BUFFER);

	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_MASK);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_DOCUMENT_NONE);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_DOCUMENT_SECTION);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_DOCUMENT_POSITION);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_SECTION_NONE);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_SECTION_POSITION);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_POSITION_NONE);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_USERDEF_DOCUMENT);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_USERDEF_SECTION);
	PRN_REGISTER_CONSTANT(GRN_OBJ_UNIT_USERDEF_POSITION);

	PRN_REGISTER_CONSTANT(GRN_OBJ_NO_SUBREC);
	PRN_REGISTER_CONSTANT(GRN_OBJ_WITH_SUBREC);

	PRN_REGISTER_CONSTANT(GRN_OBJ_KEY_VAR_SIZE);

	PRN_REGISTER_CONSTANT(GRN_OBJ_TEMPORARY);
	PRN_REGISTER_CONSTANT(GRN_OBJ_PERSISTENT);
}
