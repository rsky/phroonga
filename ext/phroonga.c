...
static zend_function_entry phroonga_functions[] = {
	...
	PHP_FE(grn_obj_db, arginfo_obj_common)
	PHP_FE(grn_obj_id, arginfo_obj_common)
	PHP_FE(grn_obj_flags, arginfo_obj_common)
	PHP_FE(grn_obj_domain, arginfo_obj_common)
